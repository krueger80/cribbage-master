        ...
        <div class="mb-8 border-b border-gray-200 dark:border-slate-700 pb-8">
            ...
            <div class="flex flex-col gap-2">
                <button class="btn justify-start w-full text-left pl-4 gap-3 h-12 text-sm font-medium transition-all rounded-lg select-none" 
                        ...
                        [class.dark:bg-emerald-900_40]="viewMode === 'analyze'" 
                        [class.text-emerald-800]="viewMode === 'analyze'" 
                        [class.dark:text-emerald-400]="viewMode === 'analyze'" 
                        [class.border-emerald-200]="viewMode === 'analyze'"
                        [class.dark:border-emerald-500_30]="viewMode === 'analyze'"
                ...
                <button class="btn justify-start w-full text-left pl-4 gap-3 h-12 text-sm font-medium transition-all rounded-lg select-none" 
                        ...
                        [class.dark:bg-emerald-900_40]="viewMode === 'history'" 
                        [class.text-emerald-800]="viewMode === 'history'" 
                        [class.dark:text-emerald-400]="viewMode === 'history'" 
                        [class.border-emerald-200]="viewMode === 'history'"
                        [class.dark:border-emerald-500_30]="viewMode === 'history'"
            ...
            <div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <button (click)="setTheme('light')" 
                            ...
                            [class.dark:bg-emerald-900_40]="theme === 'light'"
                            [class.border-emerald-200]="theme === 'light'"
                            [class.dark:border-emerald-500_50]="theme === 'light'"
                            [class.text-emerald-800]="theme === 'light'"
                            [class.dark:text-emerald-400]="theme === 'light'"
                    ...
                    <button (click)="setTheme('dark')" 
                            class="flex flex-col items-center justify-center gap-2 p-3 rounded-xl border transition-all select-none"
                            [class.bg-emerald-100]="theme === 'dark'"
                            [class.dark:bg-emerald-900_40]="theme === 'dark'"
                            [class.border-emerald-200]="theme === 'dark'"
                            [class.dark:border-emerald-500_50]="theme === 'dark'"
                            [class.text-emerald-800]="theme === 'dark'"
                            [class.dark:text-emerald-400]="theme === 'dark'"
                    ...
                    <button (click)="setTheme('auto')" 
                            ...
                            [class.dark:bg-emerald-900_40]="theme === 'auto'"
                            [class.border-emerald-200]="theme === 'auto'"
                            [class.dark:border-emerald-500_50]="theme === 'auto'"
                            [class.text-emerald-800]="theme === 'auto'"
                            [class.dark:text-emerald-400]="theme === 'auto'"
